...
def run(csv_path):
    ...
    if "gt_caption" in result_df.columns:
        expected_captions = result_df["gt_caption"]
    elif "caption" in result_df.columns:
        expected_captions = result_df["caption"]
    else:
        raise KeyError("Missing ground-truth caption column. Expected 'gt_caption' or 'caption'.")

    if "generated_caption" in result_df.columns:
        predicted_captions = result_df["generated_caption"]
    elif "predicted_caption" in result_df.columns:
        predicted_captions = result_df["predicted_caption"]
    else:
        raise KeyError("Missing generated caption column. Expected 'generated_caption' or 'predicted_caption'.")
